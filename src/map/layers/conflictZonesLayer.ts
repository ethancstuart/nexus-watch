...
import { conflictPopup } from '../PopupCard.ts';
...
const ZONES: ConflictZone[] = [
  ...
  { name: 'Philippines - NPA/ISIS', region: 'Southeast Asia', intensity: 'medium', lat: 7.5, lon: 124.5, radius: 200 },
  { name: 'Burkina Faso - JNIM', region: 'West Africa', intensity: 'high', lat: 12.3, lon: -1.5, radius: 200 },
  { name: 'Niger - Sahel', region: 'West Africa', intensity: 'high', lat: 13.5, lon: 2.1, radius: 200 },
  { name: 'Chad - Lake Chad Basin', region: 'Central Africa', intensity: 'medium', lat: 13.0, lon: 14.0, radius: 150 },
  {
  ...
  { name: 'Mexico - Cartel War', region: 'North America', intensity: 'high', lat: 24.0, lon: -104.0, radius: 400 },
  { name: 'Libya - Civil Conflict', region: 'North Africa', intensity: 'medium', lat: 32.0, lon: 13.0, radius: 300 },
  { name: 'CAR - Armed Groups', region: 'Central Africa', intensity: 'medium', lat: 6.6, lon: 20.9, radius: 200 },
  { name: 'Papua New Guinea - Tribal', region: 'Oceania', intensity: 'low', lat: -6.0, lon: 147.0, radius: 100 },
  { name: 'Ecuador - Gang War', region: 'South America', intensity: 'medium', lat: -2.2, lon: -79.9, radius: 100 },
  { name: 'Iraq - ISIS Remnants', region: 'Middle East', intensity: 'low', lat: 35.5, lon: 43.5, radius: 150 },
  { name: 'India - Kashmir LoC', region: 'South Asia', intensity: 'medium', lat: 34.1, lon: 74.8, radius: 100 },
  { name: 'India - Naxalite Belt', region: 'South Asia', intensity: 'low', lat: 22.0, lon: 82.0, radius: 300 },
];
