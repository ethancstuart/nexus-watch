...
const ENTRIES: FoodSecurityEntry[] = [
  { country: 'Sudan', iso: 'SD', lat: 15.5, lon: 32.56, ipc: 5, affectedMillions: 25.6, notes: 'Famine (El Fasher, Darfur)' },
  { country: 'South Sudan', iso: 'SS', lat: 6.88, lon: 31.3, ipc: 4, affectedMillions: 7.1, notes: 'Conflict + flooding' },
  { country: 'Yemen', iso: 'YE', lat: 15.55, lon: 48.52, ipc: 4, affectedMillions: 17.0, notes: 'Civil war, blockade' },
  { country: 'Haiti', iso: 'HT', lat: 18.97, lon: -72.28, ipc: 4, affectedMillions: 4.97, notes: 'Gang collapse, economic' },
  { country: 'Gaza', iso: 'PS', lat: 31.52, lon: 34.45, ipc: 5, affectedMillions: 1.1, notes: 'War, blockaded aid' },
  { country: 'Burkina Faso', iso: 'BF', lat: 12.37, lon: -1.52, ipc: 3, affectedMillions: 2.7, notes: 'Jihadist insurgency' },
  { country: 'Madagascar', iso: 'MG', lat: -18.77, lon: 46.87, ipc: 3, affectedMillions: 1.4, notes: 'Climate-driven drought' },
  { country: 'Somalia', iso: 'SO', lat: 5.15, lon: 46.2, ipc: 4, affectedMillions: 6.6, notes: 'Drought + Al-Shabaab' },
  { country: 'Ethiopia', iso: 'ET', lat: 9.15, lon: 40.49, ipc: 3, affectedMillions: 15.8, notes: 'Tigray aftermath + drought' },
  { country: 'Nigeria', iso: 'NG', lat: 10.4, lon: 9.08, ipc: 3, affectedMillions: 26.5, notes: 'Northeast insurgency' },
  { country: 'DR Congo', iso: 'CD', lat: -2.88, lon: 23.66, ipc: 3, affectedMillions: 25.8, notes: 'M23, displacement' },
  { country: 'Afghanistan', iso: 'AF', lat: 33.94, lon: 67.71, ipc: 3, affectedMillions: 15.8, notes: 'Taliban economic collapse' },
  ...
  { country: 'Chad', iso: 'TD', lat: 15.45, lon: 18.73, ipc: 3, affectedMillions: 3.4, notes: 'Refugee influx from Sudan' },
  { country: 'Niger', iso: 'NE', lat: 17.61, lon: 8.08, ipc: 3, affectedMillions: 3.3, notes: 'Coup, Sahel insurgency' },
  { country: 'Central African Rep.', iso: 'CF', lat: 6.61, lon: 20.94, ipc: 3, affectedMillions: 2.4, notes: 'Armed conflict' },
  { country: 'Mozambique', iso: 'MZ', lat: -18.67, lon: 35.53, ipc: 3, affectedMillions: 3.3, notes: 'Cabo Delgado insurgency' },
  { country: 'Zimbabwe', iso: 'ZW', lat: -19.02, lon: 29.15, ipc: 3, affectedMillions: 7.7, notes: 'El Niño drought' },
  { country: 'Malawi', iso: 'MW', lat: -13.25, lon: 34.3, ipc: 3, affectedMillions: 4.4, notes: 'Drought, Cyclone impact' },
  { country: 'Myanmar', iso: 'MM', lat: 21.91, lon: 95.96, ipc: 3, affectedMillions: 13.3, notes: 'Civil war' },
  { country: 'Lebanon', iso: 'LB', lat: 33.85, lon: 35.86, ipc: 3, affectedMillions: 1.6, notes: 'Economic collapse, war' },
];
