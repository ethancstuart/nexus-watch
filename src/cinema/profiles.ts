...
const ALL_LAYERS = [
  'earthquakes', 'news', 'fires', 'weather-alerts', 'predictions',
  'flights', 'cyber', 'military-bases', 'nuclear', 'ports',
  'conflict-zones', 'cables', 'pipelines', 'gps-jamming', 'satellites',
  'ships', 'acled', 'gdacs', 'chokepoints', 'air-quality',
  'diseases', 'displacement', 'internet-outages', 'sanctions',
  'elections', 'trade-routes', 'launches', 'frontlines', 'energy',
  'sentiment',
];
...
export const CINEMA_PROFILES: CinemaProfile[] = [
  ...
  },
  {
    ...
    name: 'WARFIGHTER',
    shortKey: 'WAR',
    layers: ['acled', 'conflict-zones', 'frontlines', 'military-bases', 'gps-jamming', 'sanctions', 'ships', 'flights', 'sentiment'],
    priorityRegions: [
  ...
  },
  {
    ...
    name: 'INFRASTRUCTURE',
    shortKey: 'INFRA',
    layers: ['cyber', 'cables', 'internet-outages', 'gps-jamming', 'nuclear', 'energy', 'ports', 'satellites', 'launches'],
    priorityRegions: [
  ...
  },
  {
    ...
    shortKey: 'GEO',
    layers: ['elections', 'sanctions', 'sentiment', 'acled', 'displacement', 'news', 'conflict-zones', 'internet-outages', 'predictions'],
    priorityRegions: [
  ...
  },
  {
    ...
    priorityRegions: [
      { name: 'Global View', lng: 0, lat: 20, zoom: 2.5 },
    ],
    hudMetrics: [
