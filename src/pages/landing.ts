...
export function renderLanding(root: HTMLElement): void {
  ...
  // Check if already logged in — redirect to intel map
  ...
  const heroTagline = createElement('p', {
    ...
    textContent: 'Real-time geopolitical intelligence.',
  });
  const heroSub = createElement('p', {
    className: 'landing-hero-sub',
    textContent:
      'Earthquakes, wildfires, live flights, cyber threats, news, markets, and AI sitreps \u2014 all on one interactive map with 7 data layers and a full intelligence system.',
  });
  ...
  const featuresTitle = createElement('h2', {
    ...
    textContent: 'Situational Awareness, Built from Scratch',
  });
  ...
  const featureItems = [
    {
      icon: '\uD83D\uDDFA\uFE0F',
      title: 'Intel Map',
      desc: '7 real-time data layers on a full-screen interactive map \u2014 earthquakes, wildfires, flights, cyber threats, news, weather, and prediction markets.',
    },
    {
      icon: '\uD83E\uDD16',
      title: 'AI Sitreps',
      desc: 'On-demand situation reports generated by AI from current intelligence data. Click a button, get a briefing.',
    },
    {
      icon: '\uD83C\uDF0D',
      title: 'Country Index',
      desc: '23 nations scored 0-100 across events, disasters, sentiment, and predictions. Click any country for a deep dive.',
    },
    {
      icon: '\u26A1',
      title: 'Intel Bar',
      desc: 'Real-time geospatial correlation engine detects earthquake clusters, fire convergence, and multi-signal events.',
    },
    {
      icon: '\uD83D\uDCC8',
      title: 'Dashboard Mode',
      desc: 'Classic widget dashboard with stocks, crypto, weather, news, sports, and 13 live panels in customizable spaces.',
    },
    {
      icon: '\u2328\uFE0F',
      title: 'Open Source',
      desc: 'Vanilla TypeScript, no framework. MapLibre GL + Vercel Edge Functions. MIT licensed, built with Claude Code.',
    },
  ];
