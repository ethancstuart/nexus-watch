...
const COUNTRY_PATTERNS: Array<{ pattern: RegExp; code: string }> = [
  { pattern: /\bUkraine\b/i, code: 'UA' }, { pattern: /\bRussia\b/i, code: 'RU' },
  { pattern: /\bChina\b/i, code: 'CN' }, { pattern: /\bIran\b/i, code: 'IR' },
  { pattern: /\bIndia\b/i, code: 'IN' }, { pattern: /\bBrazil\b/i, code: 'BR' },
  { pattern: /\bNigeria\b/i, code: 'NG' }, { pattern: /\bSudan\b/i, code: 'SD' },
  { pattern: /\bEthiopia\b/i, code: 'ET' }, { pattern: /\bSomalia\b/i, code: 'SO' },
  { pattern: /\bCongo\b/i, code: 'CD' }, { pattern: /\bAfghanistan\b/i, code: 'AF' },
  { pattern: /\bPakistan\b/i, code: 'PK' }, { pattern: /\bBangladesh\b/i, code: 'BD' },
  { pattern: /\bMexico\b/i, code: 'MX' }, { pattern: /\bTurkey\b|Türkiye/i, code: 'TR' },
  { pattern: /\bEgypt\b/i, code: 'EG' }, { pattern: /\bSaudi Arabia\b/i, code: 'SA' },
  { pattern: /\bIraq\b/i, code: 'IQ' }, { pattern: /\bSyria\b/i, code: 'SY' },
  { pattern: /\bYemen\b/i, code: 'YE' }, { pattern: /\bMyanmar\b|Burma\b/i, code: 'MM' },
  { pattern: /\bLebanon\b/i, code: 'LB' }, { pattern: /\bVenezuela\b/i, code: 'VE' },
  { pattern: /\bHaiti\b/i, code: 'HT' }, { pattern: /\bMali\b/i, code: 'ML' },
  { pattern: /\bKenya\b/i, code: 'KE' }, { pattern: /\bSouth Africa\b/i, code: 'ZA' },
  { pattern: /\bIndonesia\b/i, code: 'ID' }, { pattern: /\bPhilippines\b/i, code: 'PH' },
  { pattern: /\bJapan\b/i, code: 'JP' }, { pattern: /\bUnited States\b|USA\b/i, code: 'US' },
  { pattern: /\bUnited Kingdom\b|UK\b/i, code: 'GB' }, { pattern: /\bFrance\b/i, code: 'FR' },
  { pattern: /\bGermany\b/i, code: 'DE' }, { pattern: /\bItaly\b/i, code: 'IT' },
  { pattern: /\bAustralia\b/i, code: 'AU' }, { pattern: /\bCanada\b/i, code: 'CA' },
  { pattern: /\bColombia\b/i, code: 'CO' }, { pattern: /\bArgentina\b/i, code: 'AR' },
  { pattern: /\bTaiwan\b/i, code: 'TW' }, { pattern: /\bThailand\b/i, code: 'TH' },
];
