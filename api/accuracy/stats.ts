...
const NAME_MAP: Record<string, string> = {
  ...
  IQ: 'Iraq', SY: 'Syria', IL: 'Israel', PS: 'Palestine', YE: 'Yemen',
  SD: 'Sudan', SS: 'South Sudan', ET: 'Ethiopia', SO: 'Somalia',
  CD: 'DR Congo', MM: 'Myanmar', AF: 'Afghanistan', PK: 'Pakistan',
  KP: 'North Korea', KR: 'South Korea', VE: 'Venezuela', NG: 'Nigeria',
  LY: 'Libya', LB: 'Lebanon', SA: 'Saudi Arabia', US: 'United States',
  JP: 'Japan', DE: 'Germany', GB: 'United Kingdom', FR: 'France',
  IN: 'India', BR: 'Brazil', MX: 'Mexico', PH: 'Philippines',
  ID: 'Indonesia', TR: 'Turkey', EG: 'Egypt', ZA: 'South Africa',
  KE: 'Kenya', BD: 'Bangladesh', TH: 'Thailand', PL: 'Poland',
  RO: 'Romania', CO: 'Colombia', MY: 'Malaysia', IT: 'Italy',
  ES: 'Spain', AU: 'Australia', CA: 'Canada', AR: 'Argentina',
};
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    return res.json({
      ...
      meta: {
        methodology: 'V2 numeric scoring: predicted CII vs actual CII after 7-day horizon. Accurate = delta < 5 pts, Close = 5-10 pts, Miss = >10 pts.',
    ...
    return res.json({
      overview: {
        total_predictions: 0, scored: 0, pending: 0,
        accurate: 0, close: 0, miss: 0,
        accuracy_rate: null, mean_abs_error: null, median_abs_error: null,
        days_active: 0, first_recorded: null, last_scored: null,
      },
      calibration: [],
      weekly_trend: [],
      biggest_misses: [],
