...
const HIGH_SEVERITY_KEYWORDS = ['ebola', 'marburg', 'plague', 'mers', 'h5n1', 'avian influenza', 'mpox clade i', 'cholera'];
const MEDIUM_SEVERITY_KEYWORDS = ['dengue', 'measles', 'yellow fever', 'diphtheria', 'meningitis', 'lassa', 'polio', 'hepatitis'];
